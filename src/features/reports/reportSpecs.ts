...
export const REPORT_SPECS: ReportSpec[] = [
  ...
  },
  {
    ...
    filters: ['dueState', 'dateRange', 'search'],
    filterColumns: {
      dueState: 'due_status', dateRange: 'last_calibration_date',
  ...
  },
  {
    ...
    filters: ['region', 'station', 'unit', 'assetType', 'dateRange', 'search'],
    filterColumns: {
      region: 'region_id', station: 'station_id', unit: 'unit_id',
      assetType: 'asset_type', dateRange: 'observed_at',
