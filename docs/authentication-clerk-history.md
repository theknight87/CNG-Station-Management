> **HISTORICAL — superseded 2026-09-20 by Supabase Auth (migration 0056).** Kept as the record of the Clerk era. Current design: [`authentication.md`](./authentication.md).
