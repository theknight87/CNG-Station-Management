...
for suite in schema_scenarios rls_authorization rls_initplan_perf stage_b2_station_batch unit_attributes_6c unit_attributes_6c2 compressors_unit_names_6d installed_srv_warehouse_code admin_editing_photos srv_warehouse_workflow owner_station_rulings_6g ruling_linking_6h ruling_target_region_6i station_db_attributes_6j one_unit_stations_6k one_unit_asset_link_6l single_equipment_srv_link_6m; do
