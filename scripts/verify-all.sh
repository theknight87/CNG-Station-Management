...
declare -A MIN=( [schema_scenarios]=344 [rls_authorization]=705 [rls_initplan_perf]=25 [stage_b2_station_batch]=30 [unit_attributes_6c]=29 [unit_attributes_6c2]=19 [compressors_unit_names_6d]=19 [installed_srv_warehouse_code]=8 [admin_editing_photos]=24 [srv_warehouse_workflow]=44 [owner_station_rulings_6g]=16 [ruling_linking_6h]=19 [ruling_target_region_6i]=4 [station_db_attributes_6j]=13 [one_unit_stations_6k]=5 [one_unit_asset_link_6l]=6 [single_equipment_srv_link_6m]=7 [srv_snapshot_update_6n]=8 [srv_snapshot_add_archive_6o]=7 [srv_serial_identity_6p]=7 [station_region_move_6q]=6 [placeholder_equipment_6r]=6 )

for suite in schema_scenarios rls_authorization rls_initplan_perf stage_b2_station_batch unit_attributes_6c unit_attributes_6c2 compressors_unit_names_6d installed_srv_warehouse_code admin_editing_photos srv_warehouse_workflow owner_station_rulings_6g ruling_linking_6h ruling_target_region_6i station_db_attributes_6j one_unit_stations_6k one_unit_asset_link_6l single_equipment_srv_link_6m srv_snapshot_update_6n srv_snapshot_add_archive_6o srv_serial_identity_6p station_region_move_6q placeholder_equipment_6r; do
